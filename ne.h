...
#define INFINITY 100 /* Cost to a unreacheable destination router */
...
#define CONVERGE_TIMEOUT (UPDATE_INTERVAL * 10) /* if routing table is not changed after 5 update cycles, assume converged */
